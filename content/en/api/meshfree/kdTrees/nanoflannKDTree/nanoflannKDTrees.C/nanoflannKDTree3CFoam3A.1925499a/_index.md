...
hyde:
    ...
    hasher_:
      ...
      inline:
        description:
          - Tree points hasher
      key: hasher_
      type: nElementsHash<Foam::Vector<double>>
    lastTreeSize_:
      annotation:
        - protected
      description: __INLINED__
    ...
    tree_:
      ...
      inline:
        description:
          - Tree object
      key: tree_
      type: autoPtr<Foam::mff::nanoflannKDTree<Foam::Vector<double>, Foam::Field<Foam::Vector<double>>>::Tree>
  namespace:
    - Foam
    - mff
  owner: __MISSING__
  ...
  typedefs:
    ...
    Tree:
      annotation:
        - protected
      definition: nanoflann::KDTreeSingleIndexDynamicAdaptor<Adaptor, adaptor, Vector<double>::nComponents>
      description: __INLINED__
      inline:
        description:
      ...
      key: Tree
layout: class
title: nanoflannKDTree<Foam::vector, Field<Foam::vector>>
---
